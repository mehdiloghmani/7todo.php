    ...
    <div class="nav">
      ...
      <div class="menu">
        ...
        <?php foreach($folders as $folder):?>
          <li class="<?=($_GET['folder_id']=$folder->id) ?'active' : '' ?>active">
          <a href="<?= site_url("?folder_id=$folder->id")?>"><i class="fa fa-folder"></i><?=$folder->name?></a>
          <a href="?delete_folder=<?=$folder->id?>"class="remove" onclick="return confirm('Are You Sure to delete Item?');">x</a>
        </li>
           <?php endforeach;?>
        ...
        <div class="list">
          ...
          <?php foreach($tasks as $task):?>
            ...
            <span><?=$task->title?></span>
              <div class="info">
               <span class='careated-at'>Created At <?=$task->created_at?></span>
               <a href="?delete_task=<?=$task->id?>" class="remove" onclick="return confirm('Are You Sure to delete Item?\n<?=$task->title?>');">x</a>
              </div>
            </li>
            <?php endforeach;?>
            <?php else:?>
